...
public class SecurityConfiguration implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        ...
        registry.addMapping("/**")  // /** means match any string recursively
                .allowedOriginPatterns("http://localhost:*/", "http://127.0.0.1:*/", "http://kinoxpkea.azurewebsites.net/*", "http://kinoxpkea.azurewebsites.net*", "http://kinoxpkea.azurewebsites.net") //Multiple strings allowed. Wildcard * matches all port numbers.
